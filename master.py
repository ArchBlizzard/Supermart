...
cur_item = None
akshay = Market()
i1_f = Item("Uncle Chips", "Food", 15, 20, 20, True, "F1")
i2_f = Item("Kissan Tomato Ketchup", "Food", 100, 105, 105, True, "F2")
i3_f = Item("Jim Jam Treat", "Food", 30, 35, 35, True, "F3")
i4_f = Item("Jeera Cookies", "Food", 75, 80, 80, True, "F4")
i5_f = Item("Dairy Milk Silk", "Food", 150, 160, 160, True, "F5")
...
i2_c = Item("Van Heusen Sweatshirt", "Clothes", 1000, 1200, 1200, True, "C2")
i3_c = Item("Angora Wool Gloves", "Clothes", 350, 400, 400, True, "C3")
i4_c = Item("Jockey - Pack of 3 Men's brief", "Clothes", 700, 750, 750, True, "C4")
i5_c = Item("Levis - Track pant", "Clothes", 1200, 1300, 1300, True, "C5")
...
i1_s = Item("Classmate 5-in-1 Notebook", "Stationery", 250, 270, 270, True, "S1")
i2_s = Item("Classmate 100 pages ruled notebook", "Stationery", 70, 75, 75, True, "S2")
i3_s = Item("Cello Butterflow - Ball point pen (pack of 10)", "Stationery", 100, 100, 100, True, "S3")
i4_s = Item("Natraj - 15cm scale", "Stationery", 15, 15, 15, True, "S4")
i5_s = Item("Classmate Graph Book", "Stationery", 80, 90, 90, True, "S5")
...
i1_t = Item("Surf Excel - Liquid detergent", "Toiletries", 60, 65, 65, True, "T1")
i2_t = Item("Pears Gel Bar", "Toiletries", 45, 48, 48, True, "T2")
i3_t = Item("Oral B - Toothpaste", "Toiletries", 70, 80, 80, True, "T3")
i4_t = Item("Colgate - Toothbrush", "Toiletries", 20, 20, 20, True, "T4")
i5_t = Item("Pril - Dishwashing liquid", "Toiletries", 55, 55, 55, True, "T5")
...
i1_e = Item("Wipro - 9W LED bulb", "Electronics", 80, 100, 100, True, "E1")
i2_e = Item("Philips - Table lamp", "Electronics", 400, 450, 450, True, "E2")
i3_e = Item("Prestige - Electric Kettle", "Electronics", 1200, 1500, 1500, True, "E3")
i4_e = Item("Orient Electric - Electric Heater", "Electronics", 1500, 1600, 1600, True, "E4")
i5_e = Item("Electric Steamer", "Electronics", 200, 250, 250, True, "E5")
